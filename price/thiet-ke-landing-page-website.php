...
<body>
    ...
    <section class="container">
        <div class="head-service-price">
            <h3>BẢNG GIÁ THIẾT KẾ LANDING PAGE WEBSITE</h3>
        </div>
        <div class="contain-price-list">
            <div class="items-price smoothflow">
                ...
                <div class="center-item-price">
                    <li class="items-li-price">Giao diện Moblie.</li>
                    <li class="items-li-price">Thiết kế theo yêu cầu.</li>
                    <li class="items-li-price">Cài đặt các tính năng của Landing Pgae: Popup, Countdow, Form đăng kí, Chat, Call.</li>
                    <li class="items-li-price">Hỗ trợ chỉnh sửa 2 lần sau bàn giao.</li>
                    <li class="items-li-price">Tặng gói hosting sever 1.428.000 VND 1 năm lưu trữ, duy trì.</li>
                    <li class="items-li-price">Phù hợp: Các chiến dịch quảng cáo nhắm mục tiêu khách hàng truy cập bằng điện thoại di động.</li>
                    <div class="span-li-contain">
                        <li><span class="items-li-price">Chưa bao gồm giá thuê tên miền và hosting sever:</span></li>
                        <li><span class="span-li-price">Chi phí thuê tên miền: 600.000 VND - 900.000 VND/1 năm</span></li>
                        <li><span class="span-li-price">Chi phí thuê hosting sever, nơi lưu trữ website: 1.428.000 VND/ 1 năm</span></li>
                    </div>
            ...
            <div class="items-price smoothflow">
                ...
                <div class="center-item-price">
                    <li class="items-li-price">Giao diện Desktop & Mobile.</li>
                    <li class="items-li-price">Thiết kế theo yêu cầu.</li>
                    <li class="items-li-price">Cài đặt các tính năng của Landing Pgae: Popup, Countdow, Form đăng kí, Chat, Call.</li>
                    <li class="items-li-price">Hỗ trợ chỉnh sửa 2 lần sau bàn giao.</li>
                    <li class="items-li-price">Tặng gói hosting sever 1.428.000 VND 1 năm lưu trữ, duy trì.</li>
                    <li class="items-li-price">Phù hợp: Đẩy mạnh quảng cáo bán hàng, giới thiệu dịch vụ đa nền tảng.</li>
                    <div class="span-li-contain">
                        <li><span class="items-li-price">Chưa bao gồm giá thuê tên miền và hosting sever:</span></li>
                        <li><span class="span-li-price">Chi phí thuê tên miền: 600.000 VND - 900.000 VND/1 năm</span></li>
                        <li><span class="span-li-price">Chi phí thuê hosting sever, nơi lưu trữ website: 1.428.000 VND/ 1 năm</span></li>
