...
<body>
    ...
    <section class="container">
        <div class="head-service-price">
            <h3>BẢNG GIÁ THIẾT KẾ HÌNH ẢNH</h3>
        </div>
        <div class="contain-price-list">
            <div class="items-price smoothflow">
                <div class="head-item-price">
                    <h4>THIẾT KẾ CÁC ẢNH TĨNH QUẢNG CÁO</h4>
                </div>
                <div class="center-item-price">
                    <li class="items-li-price">1 Hình: 250.000 - 550.000 VND</li>
                    <li class="items-li-price">Resize: 50.000 VND</li>
                    <li class="items-li-price">Số lần chỉnh sửa: 3 lần</li>
            ...
            <div class="items-price smoothflow">
                <div class="head-item-price">
                    <h4>THIẾT KẾ CÁC ẢNH ĐỘNG QUẢNG CÁO</h4>
                </div>
                <div class="center-item-price">
                    <li class="items-li-price">1 Hình: 450.000 - 750.000 VND</li>
                    <li class="items-li-price">Resize: 90.000 VND</li>
                    <li class="items-li-price">Số lần chỉnh sửa: 5 lần</li>
                    <a id="open-modal" class="regester-pr">
                        <span class="front-pr">Đăng ký tư vấn</span>
                        <span class="center-pr"></span>
                        <span class="back-pr">Đăng ký tư vấn</span>
            ...
            <div class="items-price smoothflow">
                ...
                <div class="center-item-price">
                    <li class="items-li-price">1 Hình: 200.000 VND</li>
                    <li class="items-li-price">Resize: 50.000 VND</li>
                    <li class="items-li-price">Số lần chỉnh sửa: 5 lần</li>
                    <a id="open-modal" class="regester-pr">
                        <span class="front-pr">Đăng ký tư vấn</span>
