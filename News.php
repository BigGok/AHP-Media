    ...
    <section class="header-bg-parent">
        <div class="header-col1">
            ...
            <div class="head-blog"><a class="head-dr" href="index.html"> TRANG CHỦ</a><i
                    class="fa-solid fa-caret-right"></i> <span class="head-dr2">TIN TỨC</span></div>
        </div>
        <!--header-col1-->
            ...
            <div class="row" data-aos="fade-up">
                ...
                <div class="col-xl-8 stretch-card grid-margin">
                    <div class="position-relative">
                        <img src="images2/dashboard/banner.jpg" alt="banner" class="img-fluid2" />
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex border-bottom-blue pt-3 pb-4 align-items-center justify-content-between">
                                ...
                                <div class="rotate-img">
                                    <img src="images2/dashboard/home_1.jpg" alt="thumb" class="img-fluid img-lg" />
                                </div>
                            </div>
                            ...
                            <div class="d-flex border-bottom-blue pb-4 pt-4 align-items-center justify-content-between">
                                ...
                                <div class="rotate-img">
                                    <img src="images2/dashboard/home_3.jpg" alt="thumb" class="img-fluid img-lg" />
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-4 grid-margin">
                                    <div class="position-relative">
                                        <div class="rotate-img">
                                            <img src="images2/dashboard/home_4.jpg" alt="thumb" class="img-fluid" />
                                        </div>
                                        <div class="badge-positioned">
                                            <span class="bge badge-danger font-weight-bold">Tin Mới</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4 grid-margin">
                                    <div class="position-relative">
                                        <div class="rotate-img">
                                            <img src="images2/dashboard/home_5.jpg" alt="thumb" class="img-fluid" />
                                        </div>
                                        <div class="badge-positioned">
                                            <span class="bge badge-danger font-weight-bold">Tin Mới</span>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="position-relative">
                                        <div class="rotate-img">
                                            <img src="images2/dashboard/home_6.jpg" alt="thumb" class="img-fluid" />
                                        </div>
                                        <div class="badge-positioned">
                                            <span class="bge badge-danger font-weight-bold">Tin Mới</span>
                                        </div>
