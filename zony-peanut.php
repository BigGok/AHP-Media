...
<body>
    ...
    <section class="container">
        ...
        <img class="imgzn" src="images/Zony peanut/mẫu 1 ảnh đầu dự án.jpg" alt="">
            <img class="imgzn" src="images/Zony peanut/1.jpg" alt="">
            <img class="imgzn" src="images/Zony peanut/2.jpg" alt="">
            <img class="imgzn" src="images/Zony peanut/3.jpg" alt="">
            <img class="imgzn" src="images/Zony peanut/4.jpg" alt="">
            <img class="imgzn" src="images/Zony peanut/5.jpg" alt="">
            <img class="imgzn" src="images/Zony peanut/6.jpg" alt="">
            <img class="imgzn" src="images/Zony peanut/7.jpg" alt="">
            <img class="imgzn" src="images/Zony peanut/8.jpg" alt="">
            <img class="imgzn" src="images/Zony peanut/9.jpg" alt="">
            <img class="imgzn" src="images/Zony peanut/10.jpg" alt="">
            <img class="imgzn" src="images/Zony peanut/11.jpg" alt="">
            <img class="imgzn" src="images/Zony peanut/12.jpg" alt="">
            <img class="imgzn" src="images/Zony peanut/13.jpg" alt="">
            <img class="imgzn" src="images/Zony peanut/14.jpg" alt="">
            <img class="imgzn" src="images/Zony peanut/15.jpg" alt="">
        </div>  
    </section>
